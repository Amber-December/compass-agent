...
$outPath = 'J:\Desktop\table-1775988874328_wps下标去括号修正版.docx'
...
$rows = @(
    ...
    [ordered]@{id='M-2'; f=@('V_O_2 = 1.63 × NPP × A × P_O_2'); p='净初级生产力NPP、面积A、氧气价格P_O_2'},
...
try {
    ...
    for ($c = 1; $c -le 3; $c++) { $hr = $table.Cell(1,$c).Range; $hr.End = $hr.End - 1; $hr.Text = $headers[$c-1] }
